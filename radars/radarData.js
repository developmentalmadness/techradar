...
document.title = "inContact Orchestration Team Technology Radar (February 2016)";
...
var radar_data = [
    { "quadrant": "Techniques",
        ...
        "items" : [ 
            ...
            {"name":"Dependency Injection", "pc":{"r":280,"t":130},"movement":"c"},   
            {"name":"Isolated dev envs", "pc":{"r":280,"t":110},"movement":"c"}, 
...
{ name: 'Docker', pc: { r: 70, t: 19 }, movement: 't' },
  { name: 'Jenkins',    pc: { r: 50, t: 69 },    movement: 'c' },
  { name: 'Zookeeper',    pc: { r: 210, t: 70 },    movement: 'c',    domain: 'back-end' }, 
 { name: 'IntelliJ',    pc: { r: 80, t: 66 },    movement: 'c',    domain: 'dev' },
  { name: 'Google Hangouts',    pc: { r: 250, t: 14 },    movement: 'c' },
  { name: 'Gitter',    pc: { r: 80, t: 55 },    movement: 'c',    domain: 'communication' },
  { name: 'Git',    pc: { r: 30, t: 73 },    movement: 'c' },
  { name: 'Kafka',    pc: { r: 212, t: 25 },    movement: 'c',    domain: 'back-end' },
  { name: 'ELK',    pc: { r: 230, t: 72 },    movement: 'c',    domain: 'back-end' },
  { name: 'nginx',    pc: { r: 260, t: 60 },    movement: 'c',    domain: 'front-end' },
  { name: 'Eclipse CHE',    pc: { r: 380, t: 5 },    movement: 'c',    domain: 'mobile' },
...
*/
    ...
    { "quadrant": "Platforms",
        ...
        "items" : [
            ...
            {"name":"Github", "pc":{"r":30,"t":260},"movement":"t"},
...
*/
    ...
    { "quadrant": "Languages & Frameworks",
        ...
        "top" :   (h/2 + 18),
        "items" : [ 
            { name: 'Scala', pc: { r: 60, t: 290 },  movement: 'c' },
            { name: 'Akka', pc: { r: 60, t: 310 },  movement: 'c' },

            { name: 'Akka Streams', pc: { r: 260, t: 278 },  movement: 'c' },
            { name: 'Play!', pc: { r: 150, t: 298 },              movement: 'c',  domain: 'template' },          

            {"name":"Akka Http", "pc":{"r":230,"t":355},"movement":"c"},
